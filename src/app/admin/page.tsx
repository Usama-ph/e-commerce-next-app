...
export default async function AdminDashboard() {
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <DashboardCard title="Active Products" subtitle={`${formatNumber(productData.inactiveProductCount)} Inactive`} body={`${formatNumber(productData.activeProductCount)}`} />
...
function DashboardCard({ title, subtitle, body }: DasboardCardProps) {
    return (
        <Card>
            <CardHeader>
